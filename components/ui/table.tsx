...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'border-b border-b-zinc-950/10 px-4 py-2 font-medium first:pl-2 last:pr-2 dark:border-b-white/10',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'relative border-b border-zinc-950/5 px-4 py-4 first:pl-2 last:pr-2 dark:border-white/5',
      className,
    )}
    {...props}
  />
